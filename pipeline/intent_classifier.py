...
- "재고 있어?"/"얼마예요?" 처럼 가격·재고를 묻는 질문에 상품명(정식 명칭이든
  일부 단어든)이 같이 언급돼도, 그건 새로운 카테고리 조건 검색이 아니라 특정
  상품 하나를 콕 집어 재확인하려는 것이니 STRUCTURED_QUERY/FAQ가 아니라
  SEMANTIC_SEARCH로 분류할 것
